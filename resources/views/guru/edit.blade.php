                    ...
                    <div class="card-body">
                        <form action="{{ route('guru.update', $guru->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_mapel" id="id_mapel" class="form-control">
                                    @foreach ($mapels as $mapel)
                                        <option value="{{ $mapel->id }}" {{ $mapel->id == $guru->id_mapel ? 'selected' : '' }}>
                                            {{ $mapel->nama_mapel }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" name="nama_guru" value="{{ old('nama_guru', $mapel->nama_guru) }}" placeholder="Masukkan Nama Guru">
